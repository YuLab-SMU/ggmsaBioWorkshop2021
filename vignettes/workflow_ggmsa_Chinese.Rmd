...
protein_sequences <- system.file("extdata", "sample.fasta", package = "ggmsa")
readAAMultipleAlignment(protein_sequences) #苯丙氨酸羟化酶蛋白
ggmsa(protein_sequences, 
      start = 221, 
      end = 280, 
      char_width = 0.5,
...
```{r , fig.height=5.5, fig.width=11, message=FALSE}
...
可以结合[ClinVar Search database](https://www.ncbi.nlm.nih.gov/clinvar/)探索更多的MSA与表型的关系。
![](images/ClinVar.png)
